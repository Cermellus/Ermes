...
import nz.co.it4biz.config.Constants;
import nz.co.it4biz.domain.Authority;
import nz.co.it4biz.domain.User;
import nz.co.it4biz.repository.AuthorityRepository;
import nz.co.it4biz.repository.UserRepository;
import nz.co.it4biz.security.AuthoritiesConstants;
import nz.co.it4biz.service.MailService;
import nz.co.it4biz.service.UserService;
import nz.co.it4biz.service.dto.PasswordChangeDTO;
import nz.co.it4biz.service.dto.UserDTO;
import nz.co.it4biz.web.rest.errors.ExceptionTranslator;
import nz.co.it4biz.web.rest.vm.KeyAndPasswordVM;
import nz.co.it4biz.web.rest.vm.ManagedUserVM;
