...
public class CompanyResourceIntTest {
    ...
    private static final String DEFAULT_COMPANY_FTP_FOLDER = "AAAAAAAAAA";
    private static final String UPDATED_COMPANY_FTP_FOLDER = "BBBBBBBBBB";
    ...
    public static Company createEntity(EntityManager em) {
        Company company = new Company()
            ...
            .companyFtpFolder(DEFAULT_COMPANY_FTP_FOLDER);
        return company;
    }
    ...
    public void createCompany() throws Exception {
        ...
        assertThat(testCompany.getCompanyFtpFolder()).isEqualTo(DEFAULT_COMPANY_FTP_FOLDER);
    }
    ...
    @Test
    @Transactional
    public void checkCompanyFtpFolderIsRequired() throws Exception {
        int databaseSizeBeforeTest = companyRepository.findAll().size();
        // set the field null
        company.setCompanyFtpFolder(null);
    ...
    public void getAllCompanies() throws Exception {
        ...
        restCompanyMockMvc.perform(get("/api/companies?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].companyFtpFolder").value(hasItem(DEFAULT_COMPANY_FTP_FOLDER.toString())));
    }
    ...
    public void getCompany() throws Exception {
        ...
        restCompanyMockMvc.perform(get("/api/companies/{id}", company.getId()))
            ...
            .andExpect(jsonPath("$.companyFtpFolder").value(DEFAULT_COMPANY_FTP_FOLDER.toString()));
    }
    ...
    public void updateCompany() throws Exception {
        ...
        updatedCompany
            ...
            .companyFtpFolder(UPDATED_COMPANY_FTP_FOLDER);
        ...
        assertThat(testCompany.getCompanyFtpFolder()).isEqualTo(UPDATED_COMPANY_FTP_FOLDER);
    }
